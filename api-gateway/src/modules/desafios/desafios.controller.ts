...
export class DesafiosController {
  ...
  */
  ...
  async criarDesafio(
    ...
    */
    const categoria = await this.clientAdminBackend.send(
      'consultar-categorias', criarDesafioDto.categoria
    ).toPromise()
  ...
  async consultarDesafios(
    ...
    */
    if ( idJogador ) {
      const jogador: Jogador = 
        await this.clientAdminBackend.send('consultar-jogadores', idJogador ).toPromise()
    ...
    */
    return this.clientDesafios.send(
      'consultar-desafios', 
      { idJogador: idJogador , _id: '' }
    ).toPromise()
  }
